...
public class PersonalFormPostgreSQL {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				try {
					PersonalFormPostgreSQL window = new PersonalFormPostgreSQL();
	...
	private void initialize() {
		...
		frmPersonalDataCollection.getContentPane().setBackground(new Color(166, 160, 255));
